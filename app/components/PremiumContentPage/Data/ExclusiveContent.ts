import type { PremiumContentSliderData } from './newestSliderData'

export const ExclusiveContentData: PremiumContentSliderData = {
    slides: [
        {
            id: 's1',
    ...
    coverImage: '/images/sorosh-rafie.png',
    coverAlt: 'Suggested',
}
